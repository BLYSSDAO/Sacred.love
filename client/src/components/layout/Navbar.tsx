  ...
  const dropdownMenus: DropdownMenu[] = [
    {
      ...
      items: isAuthenticated ? [
        ...
        { name: "BLYSS Temple", href: "/about/temple" },
        { name: "The Flow Dojo", href: "/flow-dojo" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "BITFLIX Ecosystem", href: "/projects/bitflix" },
        ...
        { name: "Sacred.love", href: "/projects/sacred-love" },
        ...
        <Link href="/">
          <div className="cursor-pointer group" data-testid="link-home">
            <img 
              src={logoImage} 
              alt="BLYSS.DAO" 
              className="h-16 md:h-20 lg:h-24 w-auto object-contain group-hover:scale-105 transition-transform duration-300 drop-shadow-[0_0_8px_rgba(212,175,55,0.3)]" 
            />
          </div>
        </Link>
